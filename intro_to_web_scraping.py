...
class JSONPlaceHolderAPI:
    """ class for working with our API  """    
...
class NotesManager:
    """ class for managing notes of users, posts, comments"""
    ...
    def add_note(self, user_id, note_text):
        ...
        self.save_notes()
        print("note has been saved for user {user_id}")
...
def save_html(html_content, filename="sample_page.html"):
    """ save our html data for further exploration or analysis """    
...
def simple_html_parser(html_content, tag_name):
    ...
    while True:
        ...
        ### here's when the loop is actually running and we extract the text data
...
def parse_with_beautifulsoup(html_content):
    ...
    print(f"here are all the links  {links}")
...
if __name__ == "__main__":
    ...
    yusufs_page = fetch_webpage(web_url)

    # print(simple_html_parser(yusufs_page,"h3"))
    parse_with_beautifulsoup(yusufs_page)